...
#
# deployer <deployer_options> -f cli.scripts/enablePatterntype.py
...
# print help and exit
def help():
	print "deployer <deployer_options> -f cli.scripts/enablePatterntype.py";
...
try:
	...
	print >>sys.stderr, "Failed to enable pattern type with name:" + name + " version: " + version;
	sys.exit(1);
